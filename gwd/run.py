...
local_sverl_characteristics = characteristics.local_sverl_C_values(num_rolls=1e5, pi_Cs=pi_Cs, multi_process=False)
shapley_on_policy_characteristics = characteristics.shapley_on_policy(pi_Cs=pi_Cs, multi_process=False)
shapley_on_value_characteristics = characteristics.shapley_on_value(v_Cs=v_Cs, multi_process=False)
